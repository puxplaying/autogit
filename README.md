...
It checks for the `pkgver` and `pkgrel` of the PKGBUILD, or in case of a git package for the latest commit to update applications and can either run once or in a loop with a timer setting.
