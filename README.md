...
It compares the SHA-512 sums of the PKGBUILDS, or in case of a "-git" package - checks for the latest commit to update applications and can either run once or in a loop with a timer setting.
